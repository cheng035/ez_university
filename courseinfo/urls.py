"""haohan_cheng_ez_university URL Configuration
...
from courseinfo.models import Registration, Semester, Student, Course
from courseinfo.views import InstructorList, CourseList, StudentList, SemesterList, RegistrationList, \
    SectionList, InstructorDetail, SectionDetail, StudentDetail, SemesterDetail, CourseDetail, RegistrationDetail, \
    InstructorCreate, SectionCreate, RegistrationCreate, SemesterCreate, StudentCreate, CourseCreate, InstructorUpdate, \
    SectionUpdate, CourseUpdate, StudentUpdate, SemesterUpdate, RegistrationUpdate, InstructorDelete, SectionDelete, \
    CourseDelete, StudentDelete, SemesterDelete, RegistrationDelete
